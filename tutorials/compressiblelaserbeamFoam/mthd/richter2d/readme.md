...
- This case should be renamed to something like `bubble rise 2D`,
  as in the pure 2D case, $H_z$ will not be solved, leading to a
  solution singularity. Therefore, this case instead uses a $H_x$
  field. So the reference to the work by Richter et al. 
  (https://doi.org/10.1016/j.ijmultiphaseflow.2018.03.012) is a
  misnomer.
